...
public class TesteNumberFormat {
	...
	public static void main(String[] args) {
		...
		System.out.println("Rendimento Bruto -> " + formatador.format(investimento.getRendimentoBruto()));
		System.out.println("Rendimento Liquido -> " + formatador.format(investimento.getRendimentoLiquido()));
		System.out.println(investimento.getNomeImposto() + " -> " + formatador.format(investimento.calcularImpostos()));		
	}
}
