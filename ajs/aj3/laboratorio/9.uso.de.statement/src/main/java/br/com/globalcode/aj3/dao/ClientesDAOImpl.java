...
public class ClientesDAOImpl implements IClientesDAO {
	...
	public void excluir(String cpf) throws GlobalcodeException {
		...
		try {
			...
			String sql = DELETE_CLIENTE + cpf + "'";
			System.out.println("Executando o comando: " + sql);
				
			int result = stmt.executeUpdate(sql);
			
			// Imprimir o numero de linhas alteradas
			System.out.println("Numero de lihas alteradas: " + result);
			
		} catch(SQLException e) {
			throw new GlobalcodeException(
				"Erro ao tentar excluir o cliente pelo cpf " + cpf, e);
		} finally {
