 ...
 * 
 * Academia do Java
 * Esta classe oferece alguns metodos para interacao com usuario via prompt, como ainda nao estudamos IO
...
public class TesteClientesDAO {
    ...
    public static int leOperacao() throws IOException, NumberFormatException {
        // Utiliza o metodo estatico da classe Teclado para ler a opcao digitada
        // pelo usuario
     ...
     * necessarias para obtencao dos dados digitados.
     */
     ...
     * interacoes" necessarias para obtencao dos dados
     */
