...
import br.com.globalcode.aj4.gui.ComboClientes;
...
public class PainelCadastroClientes extends JPanel {
	...
	public PainelCadastroClientes() throws GlobalcodeException {
		 ...
		 * cbClientes
		 */
		 combo.addActionListener(new CarregarClienteListener());
